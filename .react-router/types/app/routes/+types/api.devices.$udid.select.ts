...
type Module = typeof import("../api.devices.$udid.select.js")

type Info = GetInfo<{
  file: "routes/api.devices.$udid.select.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.devices.js");
}, {
  id: "routes/api.devices.$udid.select";
  module: typeof import("../api.devices.$udid.select.js");
}];
